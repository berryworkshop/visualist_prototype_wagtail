    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_status', models.CharField(blank=True, choices=[('cancelled', 'cancelled')], max_length=25, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='gallery_images', to='events.Event')),
